...
def process_chirps():
    ...
    output_path = "/media/vortex/LaCie/LaCie/ECO_COUNTRIES/original/3857/CHIRPS_3857/"

    # WARP
    #process_tifs_warp(input_path, output_path)
    # process_tifs_warp(input_path + "/MEAN", output_path + "/CHIRPS_AVG", 'tiff')
    # process_tifs_warp(input_path + "/ANOMALY", output_path + "/CHIRPS_ANOMALY", 'tiff')
    process_tifs_warp(input_path + "/ZSCORES", output_path + "/CHIRPS_ZSCORE", 'tiff')

    # translate + gdaladdo
    input_path = "/media/vortex/LaCie/LaCie/ECO_COUNTRIES/original/3857/CHIRPS_3857/"
